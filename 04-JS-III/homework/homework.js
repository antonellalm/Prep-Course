...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  // y devuelve el array
  // Tu código: tambien lo podia hacer mas facil : array.push(elemento), return array;
 nuevoarray=[]
 for(var i= 0; i<array.length; i++)
...
function numeroMasGrande(numeros) {
  ...
  // Tu código: tambien se puede hacer con Math.max()
  var total=0
  for (var i=0; i< numeros.length; i++){
     if (numeros[i]>total) {
      total = numeros[i]
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí--- vartodos iguales/ = 
